...
export default function FullSizeImage() {
  ...
  return (
    <div
      className="z-[999] fixed w-screen h-screen flex items-center justify-center bg-[#000000aa] overflow-hidden"
      onClick={() => toggleDisplayFullSizeImageAtom()}
    >
      <div
        className="z-[1000] rounded w-[90%] h-[90%] max-h-[400px] sm:max-h-[600px] max-w-[600px] bg-[#f1f1f1] dark:bg-[#313131] p-2"
